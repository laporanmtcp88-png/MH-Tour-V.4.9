...
android {
    ...
    defaultConfig {
        ...
        val tokenServerId = (project.findProperty("MH_TOUR_TOKEN_SERVER_ID") as String?)?.trim().orEmpty()
        buildConfigField("String", "MH_TOUR_TOKEN_SERVER_ID", "\"$tokenServerId\"")
    }
